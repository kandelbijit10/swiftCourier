...
<head>
    ...
    <title>Customer Register - Swift Courier</title>
    ...
    <style>
        * {
        ...
        body {
            min-height: 100vh;
            background: linear-gradient(135deg, #75a0cb 0%, #e2e8f0 100%);
            display: flex;
        ...
        <div class="login-wrapper">
            ...
            <div class="login-image">
                <div class="login-image-content">
                    ...
                    <p>Join our network to enjoy seamless logistics services. Track your shipments, manage deliveries, and experience premium courier services.</p>
                </div>
            </div>
        </div>
    </div>
