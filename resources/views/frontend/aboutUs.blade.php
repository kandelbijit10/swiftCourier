...
<body>
    <div class="heads">
        ...
        <h1>About Us</h1>
        <p>Welcome to Swift Courier, your trusted partner for real-time courier tracking.</p>
    </div>
    <div class="section1">
        <div class="sec">
            <div class="design"></div>
            <h2>Who are we?</h2>
            <p>We are a passionate team of logistics experts who believe in the power of seamless delivery. Like a Swift Courier, we work together tirelessly to ensure that your packages reach their destination safely and efficiently. Our dedication to precision, tracking, and customer service sets us apart in the world of couriers.</p>
        </div>
        <div class="sec">
            <div class="design"></div>
            <h2>Our Mission</h2>
    ...
    <div class="section2">
        ...
        <div class="slot2">
            <h2>Why Choose us</h2>
            <p>At Swift Courier, we make tracking your shipments effortless and reliable. Our cutting-edge technology provides real-time updates, ensuring you’re always informed about your package’s location. With a user-friendly interface and dedicated customer support, we prioritize your peace of mind. Trust us to deliver accuracy, transparency, and exceptional service every time.</p>
            <br>
...
<div class="row">
    <div class="column">
        <img src="images/bijit.jpeg" alt="Founder">
        <p class="role">Bijit Kandel</p>
        <p class="role">Founder</p>
    </div>
    <div class="column">
        <img src="images/rahul.JPG" alt="Co-Founder">
        <p class="role">Rahul</p>
